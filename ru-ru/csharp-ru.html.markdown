...
C# это элегантный и типо-безопасный объектно-ориентированный язык, который позволяет разработчким создавать множество защищённых и безопасных приложений, которые работают на платформе .NET Framework.

[Подробнее читайте здесь.](http://msdn.microsoft.com/en-us/library/vstudio/z1zx9t92.aspx)
...
*/
/// <summary>
/// Это XML документирование, которое может быть использовано для генерации
/// документации или обеспечения контекстной помощи в среде разрботки
/// </summary>
